...
<body>
  <!--© Designed and coded by @arata74-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/1acb964d37dcbb9fe7fb5.jpg"
          alt="logo"
        />
        <a href="https://t.me/AnimeRepublicMLR"> 
          <h2 class="name">mirror bot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/yuno74/new-mirror"><i class="fab fa-github"></i></a>
        <a href="https://t.me/AnimeRepublicMLR"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/1acb964d37dcbb9fe7fb5.jpg" type="image/jpg"> 
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap"
